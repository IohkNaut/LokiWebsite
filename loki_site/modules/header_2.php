	...
	<div class="container-fluid">
    	<div class="row">
        	<div class="top ">
                ...
                <form class="navbar-form navbar-left col-md-4 col-sm-4 col-xs-4" method="get" role="search" style="float: left;margin-top: 22px; margin-left: 50px;">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Nhập sản phẩm cần tìm" style="width:250px;">
                        <button type="button" class="btn btn-default">Tìm kiếm</button>
                    </div>
                    
                </form>
                
                <div class="col-md-1 col-sm-1 col-xs-2" style="float: right;margin-top: 26px; color:#191919;"><!--gio hang-->
                    <a href="cart.php">
                ...
                <div class="col-md-2 col-sm-3 col-xs-4" style="float: right;margin-top: 5px;"><!--dang nhap-->
                    <div style="padding-left:30px; font-weight:bold;">Hi, Trần Khánh Linh</div>
                    <a href="register.php?loginview=info">
