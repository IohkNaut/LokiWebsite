	...
	<div class="container-fluid">
    	<div class="row">
        	<div class="top ">
                ...
                <form class="navbar-form navbar-left col-md-4 col-sm-4 col-xs-4" method="post" role="form" style="float: left;margin-top: 22px; margin-left: 50px;" action="" enctype="multipart/form-data">
                ...
                <div class="col-md-2 col-sm-2 col-xs-4" style="float: right;margin-top: 21px;"><!--dang nhap-->
                    ...
                    <a href="index.php?manage=mnadmin&ac=edit&id=<?php echo $admin['admin_id'];?>">
